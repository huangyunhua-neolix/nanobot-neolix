...
| **M4** | DSPy + GEPA 接入 + 评测数据 4 级分层 + LLM-as-judge rubric + 5 道闸门的前 3 道（测试/大小/cache 兼容） | M1 | 🚧 进行中 (2026-06-12, branch `feature/m4-offline-skeleton` @ d0d5f522) | `specs/m4-offline-skeleton.md` | `plans/m4-offline-skeleton.md` | — |
